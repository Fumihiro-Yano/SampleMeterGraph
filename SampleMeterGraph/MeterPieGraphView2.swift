//
//  MeterPieGraphView2.swift
//  SampleMeterGraph
//
//  Created by 矢野史洋 on 2016/05/15.
//  Copyright © 2016年 矢野史洋. All rights reserved.
//

import UIKit

class MeterPieGraphView2: UIView {
    ...
    func getPlusParams(params:[Dictionary<String,AnyObject>]) -> (palams: [Dictionary<String,AnyObject>], movingMeter: String){
        ...
        if((params[0]["value"]! as! Int) >= (_params[0]["value"]! as! Int)) {
           plusParams.append(["value":params[0]["value"]! as! Int,"color":UIColor.redColor()])
           meter = "left"
        }
        else if ((params[0]["value"]! as! Int) <= (_params[0]["value"]! as! Int)) {
           plusParams.append(["value":params[1]["value"]! as! Int,"color":UIColor.blueColor()])
           meter = "right"
        }
